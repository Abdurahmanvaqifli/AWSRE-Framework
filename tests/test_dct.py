"""
AWSRE DCT Watermarker Test
"""

import cv2
import numpy as np

from watermarking.dct import DCTWatermarker
...
def run_test():
    print("=" * 72)
    print("AWSRE DCT WATERMARKER TEST")
    print("=" * 72)
    ...
    assert is_registered("DCT")
    assert "DCT" in list_registered_methods()

    factory_algorithm = create_watermarker(
        method="dct",
        alpha=20,
    )
